            ...
            <div className="max-w-md w-full space-y-8 bg-black/40 backdrop-blur-xl p-10 rounded-3xl shadow-2xl border border-white/10 relative z-10">
                <div>
                    ...
                    <p className="mt-2 text-center text-sm text-indigo-200/70">
                        ...
                        <Link href="/signup" className="font-medium text-pink-400 hover:text-pink-300 transition-colors drop-shadow-sm">
                            Sign up today
                        </Link>
                    </p>
                </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <div className="flex justify-between items-center mb-1">
                                ...
                                <Link href="/forgot-password" className="text-sm font-medium text-pink-400 hover:text-pink-300 transition-colors drop-shadow-sm">
                                    Forgot password?
                                </Link>
                            </div>
                            <div className="relative">
                ...
                <div className="mt-6">
                    ...
                    <div className="mt-6">
                        <button
                            ...
                            disabled={loading}
                            className="w-full inline-flex justify-center items-center py-3 px-4 border border-zinc-700 rounded-lg shadow-sm bg-zinc-900/50 text-sm font-medium text-white hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors disabled:opacity-50"
                        >
